...
import pr5 from '../assets/images/products/5002.jpg'
import pr6 from '../assets/images/products/5003.png'
import pr7 from '../assets/images/products/5004.png'
import pr8 from '../assets/images/products/5005.png'
        ...
        <div className="row">
            <div className="col-12 d-flex justify-content-center">
                ...
                <div className="col-6 d-flex  justify-content-center flex-column">
                    ...
                    <div className='mb-4'>
                        <p>Rs&nbsp;{props.price}&nbsp; <strike className = 'text-danger'></strike></p>
                    </div>
